                        ...
                        <div id="roomGallery"
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <img src="https://cdnturint.touristica.com.tr/otel-resimleri/v1.00/reges-a-luxury-collection-resort-spa/900x600/reges-a-luxury-collection-resort-oda-aegean_136694.jpg"
                                         alt="${room.roomName}"
                                         onerror="this.onerror=null; this.src='https://placehold.co/800x600?text=Room+2';">
                                </div>

                                <div class="carousel-item">
                                    <img src="https://res.klook.com/image/upload/fl_lossy.progressive%2Cq_85/c_fill%2Cw_1000/v1660125874/blog/o6doqv8vwrhsjb1tyokx.jpg"
                                         alt="${room.roomName}"
                                         onerror="this.onerror=null; this.src='https://placehold.co/800x600?text=Room+3';">
                                </div>

                                <div class="carousel-item">
                                    <img src="https://www.ticati.com/img/hotel/19454583s.jpg"
                                         alt="${room.roomName}"
                                         onerror="this.onerror=null; this.src='https://placehold.co/800x600?text=Room+4';">
                                </div>

                                <div class="carousel-item">
                                    <img src="https://contenu.nyc3.digitaloceanspaces.com/journalist/def51bb4-28fd-4a97-bbb4-f24722e648b4/thumbnail.jpeg"
                                         alt="${room.roomName}"
                                         onerror="this.onerror=null; this.src='https://placehold.co/800x600?text=Room+5';">
                                </div>

                                <div class="carousel-item">
                                    <img src="https://cdn.mos.cms.futurecdn.net/NKxs7o4onnCjzmbnY83QJQ.jpg"
                                         alt="${room.roomName}"
