                ...
                <div class="card-body p-4">
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/contact">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="subject" class="form-control" placeholder="Nhập tiêu đề liên hệ..." required>
                        </div>

                        <!-- Message -->
                        <div class="mb-3">
                            <label class="form-label fw-bold">Nội dung tin nhắn</label>
                            <textarea name="message" class="form-control" rows="4" placeholder="Nhập nội dung tin nhắn của bạn..." required></textarea>
                        </div>
