        ...
        <div class="col-md-9">
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body p-3">
                    <form method="get" action="${pageContext.request.contextPath}/room" class="row g-2">
                        ...
                        <c:otherwise>
                            <div class="table-responsive">
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        <c:forEach var="room" items="${list}" varStatus="s">
                                            <tr>
                                                ...
                                                <td class="text-muted small">${room.categoryID}</td>
                                                <td class="text-end fw-bold text-success">
                                                    <fmt:formatNumber value="${room.price}" type="number"/>đ
                                                </td>
                                                <td class="text-center">
                                                    <i class="fa-solid fa-bed text-secondary me-1"></i>${room.bed}
                                                </td>
                                                <td class="text-center">
                                                    <c:choose>
                                                ...
                                                <td class="text-center">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <li>
                                                                <form method="post"
                                                                    ...
                                                                    <input type="hidden" name="action" value="updateStatus">
                                                                    <input type="hidden" name="roomId" value="${room.roomID}">
                                                                    <input type="hidden" name="status" value="Bảo trì">
                                                                    <button type="submit" class="dropdown-item">
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            onclick="confirmDeleteRoom(${room.roomID}, '${room.roomNumber}')"
                                                            title="Xóa">
        ...
        <div class="modal-content">
            <div class="modal-header bg-danger text-white">
                <h5 class="modal-title">
                    <i class="fa-solid fa-triangle-exclamation me-2"></i>Xác nhận xóa phòng
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                Bạn có chắc muốn xóa phòng số <strong id="deleteRoomNum"></strong>?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
                <a id="deleteRoomBtn" href="#" class="btn btn-danger">
